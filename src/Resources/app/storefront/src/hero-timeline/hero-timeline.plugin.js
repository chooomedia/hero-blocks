...
export default class HeroTimelinePlugin extends Plugin {
  ...
  init() {
    this.items = Array.from(
      this.el.querySelectorAll(this.options.itemSelector)
    );
    this.yearBtns = Array.from(
      this.el.querySelectorAll(this.options.yearBtnSelector)
    );
    this.activeBadge = this.el.querySelector(this.options.activeBadgeSelector);
    this.verticalLine = this.el.querySelector(
      this.options.verticalLineSelector
    );
  ...
  _initSliders() {
    this.items.forEach((item, itemIndex) => {
      const slides = Array.from(
        item.querySelectorAll(this.options.slideSelector)
      );
