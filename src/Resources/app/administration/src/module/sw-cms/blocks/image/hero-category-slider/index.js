...
Shopware.Component.register("sw-cms-preview-hero-category-slider", () =>
  import("./preview/index.js")
);
Shopware.Component.register("sw-cms-block-hero-category-slider", () =>
  import("./component/index.js")
);
Shopware.Component.register("sw-cms-block-config-hero-category-slider", () =>
...
Shopware.Service("systemConfigApiService")
  ...
  .then((values) => {
    if (values && values[configKey] !== undefined) {
      ...
      const blockRegistry =
        Shopware.Service("cmsService").getCmsBlockRegistry();
