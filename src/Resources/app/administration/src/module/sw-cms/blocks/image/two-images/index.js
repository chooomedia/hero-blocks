...
Shopware.Component.register('sw-cms-preview-two-images', () => import('./preview/index.js'));
Shopware.Component.register('sw-cms-block-two-images', () => import('./component/index.js'));
...
const blockConfig = {
    ...
    category: 'image',
    component: 'sw-cms-block-two-images',
    previewComponent: 'sw-cms-preview-two-images',
    defaultConfig: {
        marginBottom: '0',
        marginTop: '0',
        marginLeft: null,
