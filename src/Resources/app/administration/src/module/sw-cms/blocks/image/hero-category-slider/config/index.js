 ...
 * - Custom Settings: Werden im Element-Modal konfiguriert (siehe sw-cms-el-config-hero-category-slider)
 */
import template from './sw-cms-block-config-hero-category-slider.html.twig';
import './sw-cms-block-config-hero-category-slider.scss';
